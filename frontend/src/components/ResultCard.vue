...
import { ExternalLink, User, ArrowUp, Calendar } from 'lucide-vue-next'
      ...
      <CardHeader class="pb-3">
        <div class="flex items-start justify-between gap-3">
          <div class="flex-1 min-w-0">
            <span class="text-sm font-semibold leading-snug hover:text-primary transition-colors line-clamp-2">
              {{ result.story_title }}
            </span>
